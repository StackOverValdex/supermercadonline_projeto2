...
public class Codigo_Postal
{
    ...
    //
    public void adicionarCodigoPostais(String s1,String s2)
    {
        // PreparedStatement
        ...
        try
        {
            ...
            st.setString(1, this.caixapostal=s1);
            st.setString(2, this.localidade=s2);
    ...
    public void editarCodigoPostais(String l)
    {
        // PreparedStatement
        Connection conn = oracleDB_connection.createConnection();
        ...
        try
        {
            PreparedStatement st = conn.prepareStatement(l);
            st.execute();
